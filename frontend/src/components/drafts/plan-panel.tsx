...
import { useDraftPlan, useUpdateDraftPlan } from '@/lib/hooks/use-drafts'
...
export function PlanPanel({
  ...
  async function save(): Promise<boolean> {
    ...
    try {
      ...
      toast.success('Plan saved as a new version.')
      return true
    } catch {
    ...
    <div className="flex flex-col gap-5">
      <div className="flex items-center gap-2">
        <div>
          ...
          <p className="text-text-tertiary text-xs">{plan.status}</p>
        </div>
                ...
                <div className="grid gap-3">
                  ...
                  <div className="grid gap-1.5">
                    ...
                    <Textarea
                      ...
                      className="min-h-20"
                      value={section.claim}
                      onChange={(event) => changeSection(section.id, { claim: event.target.value })}
                    />
                  </div>
                  <div className="grid gap-1.5">
