  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          'fixed top-1/2 left-1/2 z-50 grid w-full max-w-[calc(100%-2rem)] -translate-x-1/2 -translate-y-1/2 gap-4 rounded-lg border bg-popover p-4 text-sm text-popover-foreground shadow-lg duration-200 outline-none sm:max-w-sm data-open:animate-in data-open:fade-in-0 motion-safe:data-open:slide-in-from-top-2 data-closed:animate-out data-closed:fade-out-0 motion-safe:data-closed:slide-out-to-top-2',
          className,
        )}
        {...props}
      >
